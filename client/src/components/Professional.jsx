...
import "../index.css";
export default function Professional({ name,specialization,available,totalRatings, totalScore }){ 
      ...
      {/* <div className="bg-gray-200 h-screen w-full flex justify-center items-center"> */}
        <div className="user-card relative flex flex-col rounded-lg w-96 mx-auto bg-white pb-5 mt-20">
          ...
          <div className="flex mt-2 justify-center items-center">
            ...
            <p className="text-sm ms-1 font-semibold">
              ({totalRatings} reviews)
            </p>
          </div>
          <div className="mx-auto my-4">
            <button className="bg-black text-white px-4 py-2 rounded-full">Book a counselling session</button>
          </div>
        </div>
      {/* </div> */}
    </>
